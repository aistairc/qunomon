...
echo open eclipse
echo;
%CHROME% --app=http://localhost:3010 --disable-background-mode --disable-extensions

echo open jupyter
echo;
%CHROME% --app=http://localhost:9888?token=token --disable-background-mode --disable-extensions
