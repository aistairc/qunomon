...
with DAG('eval_regression_analyze_coefficient_determination_tf2.3_0.1', default_args=default_args, schedule_interval=None, catchup=False) as dag:
    ...
    t2 = DockerOperatorEx(
        ...
        image='qunomon/eval_regression_analyze_coefficient_determination_tf2.3:0.1',
