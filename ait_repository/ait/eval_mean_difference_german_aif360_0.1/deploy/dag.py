...
with DAG('eval_mean_difference_german_aif360_0.1', default_args=default_args, schedule_interval=None, catchup=False) as dag:
    ...
    t2 = DockerOperatorEx(
        ...
        image='qunomon/eval_mean_difference_german_aif360:0.1',
