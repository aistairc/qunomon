...
with DAG('dev_template_local_docker_0.1', default_args=default_args, schedule_interval=None, catchup=False) as dag:
    ...
    t2 = DockerOperatorEx(
        ...
        image='localhost:5500/dev_template_local_docker:0.1',
