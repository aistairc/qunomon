...
with DAG('eval_coverage_ca_pairwise_0.1', default_args=default_args, schedule_interval=None, catchup=False) as dag:
    ...
    t2 = DockerOperatorEx(
        ...
        image='qunomon/eval_coverage_ca_pairwise:0.1',
