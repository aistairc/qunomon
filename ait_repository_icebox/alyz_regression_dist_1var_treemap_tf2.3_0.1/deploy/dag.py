...
with DAG('alyz_regression_dist_1var_treemap_tf2.3_0.1', default_args=default_args, schedule_interval=None, catchup=False) as dag:
    ...
    t2 = DockerOperatorEx(
        ...
        image='docker.pkg.github.com/m-akita-aist/qai-testbed/alyz_regression_dist_1var_treemap_tf2.3:0.1',
        docker_conn_id='my_docker_repo',
