...
with DAG('dev_template_0.1', default_args=default_args, schedule_interval=None, catchup=False) as dag:
    ...
    t2 = DockerOperatorEx(
        ...
        image='docker.pkg.github.com/m-akita-aist/qai-testbed/dev_template:0.1',
