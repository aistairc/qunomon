...
with DAG('regression_model_evaluation_0.1', default_args=default_args, schedule_interval=None, catchup=False) as dag:
    ...
    t2 = DockerOperatorEx(
        ...
        image='127.0.0.1:5500/dev_hello_world:0.1',
