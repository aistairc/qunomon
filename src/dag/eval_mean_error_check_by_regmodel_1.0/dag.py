...
with DAG('eval_mean_error_check_by_regmodel_1.0', default_args=default_args, schedule_interval=None, catchup=False) as dag:
    ...
    t2 = DockerOperatorEx(
        ...
        image='127.0.0.1:5500/eval_mean_error_check_by_regmodel:1.0',
