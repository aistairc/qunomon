...
with DAG('eval_handwrite_acc_tf2.3_0.1', default_args=default_args, schedule_interval=None, catchup=False) as dag:
    ...
    t2 = DockerOperatorEx(
        ...
        image='registry:5500/eval_handwrite_acc_tf2.3:0.1',
