...
with DAG('{AIT_NAME}_{AIT_VERSION}', default_args=default_args, schedule_interval=None, catchup=False) as dag:
    ...
    t2 = DockerOperatorEx(
        ...
        image='docker.pkg.github.com/m-akita-aist/qai-testbed/{AIT_NAME}:{AIT_VERSION}',
