...
class Inventory:
    def __init__(self, id_: int, name: str, type_: DataType, description: str, file_path, template_inventory_id: int,
                 template_inventory_name: str) -> None:
        self.id_ = id_
        self.name = name
        self.type_ = type_
        ...
        self.template_inventory_name = template_inventory_name
...
class QualityMeasurement:
    def __init__(self, id_: int, enable: bool, name: Optional[str] = None,
                 ...
                 value: Optional[str] = None, relational_operator_id: Optional[int] = None,
                 run_measure_value: str = None) -> None:
        self.id_ = id_
        self.name = name
        self.description = description
        ...
        self.enable = enable
        self.run_measure_value = run_measure_value
...
class TestRunner:
    def __init__(self, 
        id_: int, 
        params: List[TestRunnerParam],
        name: Optional[str] = None, 
        description: str = None, 
        source_repository: str = None, 
        create_user_account: str = None,
...
class InventorySchema(BaseSchema):
    ...
    template_inventory_name = fields.Str(data_key='TemplateInventoryName')
...
class QualityMeasurementSchema(BaseSchema):
    ...
    run_measure_value = fields.Str(data_key='RunMeasureValue', required=False)
...
class TestRunnerSchema(BaseSchema):
    ...
    install_mode = fields.Str(data_key='InstallMode', required=False)
    install_status = fields.Str(data_key='InstallStatus', required=False)
...
class UsingTestDescription:
    def __init__(self, test_description_id: int, test_runner_id: int, ml_component_id: int) -> None:
        self.test_description_id = test_description_id
        self.test_runner_id = test_runner_id
        self.ml_component_id = ml_component_id


class GetUsingTestDescriptionsRes:
    def __init__(self, result: Result, using_Test_Descriptions: List[UsingTestDescription]) -> None:
        self.result = result
        self.using_Test_Descriptions = using_Test_Descriptions


class UsingTestDescriptionSchema(BaseSchema):
    __model__ = UsingTestDescription
    test_description_id = fields.Int(data_key='TestDescriptionID')
    test_runner_id = fields.Int(data_key='TestRunnerID')
    ml_component_id = fields.Int(data_key='MlComponentID')


class GetUsingTestDescriptionsResSchema(BaseSchema):
    __model__ = GetUsingTestDescriptionsRes
    result = fields.Nested(ResultSchema, data_key='Result')
    using_Test_Descriptions = fields.Nested(UsingTestDescriptionSchema, data_key='UsingTD', many=True)
