...
from ..controllers.dto.ait_manifest import Measure
...
class QualityMeasurementMapper(sql_db.Model):
    ...
    @hybrid_method
    def to_dto(self, operand_mapper: OperandMapper, run_measure_value: str) -> QualityMeasurement:
        return QualityMeasurement(
            ...
            run_measure_value=run_measure_value
        )
