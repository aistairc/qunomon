...
class ResourceManager():
    ...
    def __make_summary_overview(self, summarydir_path: str):
        ...
        try:
            ...
            plt.savefig(summarydir_path + 'overview.svg')
    ...
    def __make_summary_radarchart(self, summarydir_path: str):
        ...
        try:
            ...
            plt.yticks(display_range_list, display_range_list, color="black", size=10)
            plt.ylim(0, max_range)

            # Plot
            ax.plot(angles, values, linewidth=1, c='m', linestyle='solid')
            ax.fill(angles, values, 'r', alpha=0.2)
            plt.savefig(summarydir_path + 'summary.png', dpi=300)
    ...
    # TD単位のhtmlを作成する
    def make_frame_html(self, output_path: Path, is_resource_exists: bool = True):
        # TD_RESOURCES置換
