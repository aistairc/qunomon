...
--
-- Name: M_Organization_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--
...
ALTER TABLE public."M_Organization_id_seq" OWNER TO "user";
...
--
-- Name: M_User; Type: TABLE; Schema: public; Owner: user
--
...
ALTER TABLE public."M_User" OWNER TO "user";

--
-- Name: M_User_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--
...
ALTER TABLE public."M_User_id_seq" OWNER TO "user";

--
-- Name: M_User_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user
--
...
--
-- Name: M_User_Role_MLComponent; Type: TABLE; Schema: public; Owner: user
--

CREATE TABLE public."M_User_Role_MLComponent" (
    id integer NOT NULL,
    user_id integer,
    role_id integer,
    ml_component_id integer,
...
ALTER TABLE public."M_User_Role_MLComponent" OWNER TO "user";

--
-- Name: M_User_Role_MLComponent_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

CREATE SEQUENCE public."M_User_Role_MLComponent_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."M_User_Role_MLComponent_id_seq" OWNER TO "user";

--
-- Name: M_User_Role_MLComponent_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user
--

ALTER SEQUENCE public."M_User_Role_MLComponent_id_seq" OWNED BY public."M_User_Role_MLComponent".id;
...
--
-- Name: M_Quality_Dimension_Level; Type: TABLE; Schema: public; Owner: user
--

CREATE TABLE public."M_Quality_Dimension_Level" (
    id integer NOT NULL,
...
ALTER TABLE public."M_Quality_Dimension_Level" OWNER TO "user";

--
-- Name: M_Quality_Dimension_Level_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

CREATE SEQUENCE public."M_Quality_Dimension_Level_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."M_Quality_Dimension_Level_id_seq" OWNER TO "user";

--
-- Name: M_Quality_Dimension_Level_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user
--

ALTER SEQUENCE public."M_Quality_Dimension_Level_id_seq" OWNED BY public."M_Quality_Dimension_Level".id;
...
--
-- Name: M_ReportTemplate; Type: TABLE; Schema: public; Owner: user
--

CREATE TABLE public."M_ReportTemplate" (
    id integer NOT NULL,
    guideline_id integer,
    name character varying NOT NULL,
    creation_datetime timestamp without time zone,
...
ALTER TABLE public."M_ReportTemplate" OWNER TO "user";

--
-- Name: M_ReportTemplate_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

CREATE SEQUENCE public."M_ReportTemplate_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."M_ReportTemplate_id_seq" OWNER TO "user";

--
-- Name: M_ReportTemplate_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user
--

ALTER SEQUENCE public."M_ReportTemplate_id_seq" OWNED BY public."M_ReportTemplate".id;
...
--
-- Name: M_Scope; Type: TABLE; Schema: public; Owner: user
--

CREATE TABLE public."M_Scope" (
    id integer NOT NULL,
...
ALTER TABLE public."M_Scope" OWNER TO "user";

--
-- Name:M_Scope_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

CREATE SEQUENCE public."M_Scope_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."M_Scope_id_seq" OWNER TO "user";

--
-- Name: M_Scope_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user
--

ALTER SEQUENCE public."M_Scope_id_seq" OWNED BY public."M_Scope".id;


--
-- Name: M_Scope_QualityDimension; Type: TABLE; Schema: public; Owner: user
--

CREATE TABLE public."M_Scope_QualityDimension" (
    id integer NOT NULL,
    guideline_id integer,
    scope_id integer,
    quality_dimension_id integer,
...
ALTER TABLE public."M_Scope_QualityDimension" OWNER TO "user";

--
-- Name:M_Scope_QualityDimension_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

CREATE SEQUENCE public."M_Scope_QualityDimension_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."M_Scope_QualityDimension_id_seq" OWNER TO "user";

--
-- Name: M_Scope_QualityDimension_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user
--

ALTER SEQUENCE public."M_Scope_QualityDimension_id_seq" OWNED BY public."M_Scope_QualityDimension".id;
...
--
-- Name: M_TestInventoryTemplate_Compatible_Package; Type: TABLE; Schema: public; Owner: user
--

CREATE TABLE public."M_TestInventoryTemplate_Compatible_Package" (
    id integer NOT NULL,
    inventory_template_id integer,
    name character varying NOT NULL,
...
ALTER TABLE public."M_TestInventoryTemplate_Compatible_Package" OWNER TO "user";

--
-- Name: M_TestInventoryTemplate_Compatible_Package_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

CREATE SEQUENCE public."M_TestInventoryTemplate_Compatible_Package_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."M_TestInventoryTemplate_Compatible_Package_id_seq" OWNER TO "user";

--
-- Name: M_TestInventoryTemplate_Compatible_Package_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user
--

ALTER SEQUENCE public."M_TestInventoryTemplate_Compatible_Package_id_seq" OWNED BY public."M_TestInventoryTemplate_Compatible_Package".id;



--
-- Name: M_TestInventoryTemplate_Additional_Info; Type: TABLE; Schema: public; Owner: user
--

CREATE TABLE public."M_TestInventoryTemplate_Additional_Info" (
    id integer NOT NULL,
    inventory_template_id integer,
    key character varying NOT NULL,
    value character varying
...
ALTER TABLE public."M_TestInventoryTemplate_Additional_Info" OWNER TO "user";

--
-- Name: M_TestInventoryTemplate_Additional_Info_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

CREATE SEQUENCE public."M_TestInventoryTemplate_Additional_Info_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."M_TestInventoryTemplate_Additional_Info_id_seq" OWNER TO "user";

--
-- Name: M_TestInventoryTemplate_Additional_Info_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user
--

ALTER SEQUENCE public."M_TestInventoryTemplate_Additional_Info_id_seq" OWNED BY public."M_TestInventoryTemplate_Additional_Info".id;
...
CREATE TABLE public."M_TestRunnerReference" (
    id integer NOT NULL,
    bib_info character varying NOT NULL,
    additional_info character varying,
...
--
-- Name: M_Role; Type: TABLE; Schema: public; Owner: user
--
...
ALTER TABLE public."M_Role" OWNER TO "user";

--
-- Name:M_Role_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--
...
ALTER TABLE public."M_Role_id_seq" OWNER TO "user";

--
-- Name: M_Role_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user
--

ALTER SEQUENCE public."M_Role_id_seq" OWNED BY public."M_Role".id;

--
-- Name: M_Guideline; Type: TABLE; Schema: public; Owner: user
--

CREATE TABLE public."M_Guideline" (
    id integer NOT NULL,
...
ALTER TABLE public."M_Guideline" OWNER TO "user";

--
-- Name:M_Guideline_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

CREATE SEQUENCE public."M_Guideline_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."M_Guideline_id_seq" OWNER TO "user";

--
-- Name: M_Guideline_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user
--

ALTER SEQUENCE public."M_Guideline_id_seq" OWNED BY public."M_Guideline".id;


--
-- Name: M_Guideline_Schema_File; Type: TABLE; Schema: public; Owner: user
--

CREATE TABLE public."M_Guideline_Schema_File" (
    id integer NOT NULL,
    guideline_id integer,
    name character varying NOT NULL,
    guideline_schema_file jsonb,
    creation_datetime timestamp without time zone,
    update_datetime timestamp without time zone,
    delete_flag boolean
);
...
ALTER TABLE public."M_Guideline_Schema_File" OWNER TO "user";

--
-- Name:M_Guideline_Schema_File_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

CREATE SEQUENCE public."M_Guideline_Schema_File_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."M_Guideline_Schema_File_id_seq" OWNER TO "user";

--
-- Name: M_Guideline_Schema_File_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user
--

ALTER SEQUENCE public."M_Guideline_Schema_File_id_seq" OWNED BY public."M_Guideline_Schema_File".id;
...
--
-- Name: T_RunMeasure; Type: TABLE; Schema: public; Owner: user
--

CREATE TABLE public."T_RunMeasure" (
    id integer NOT NULL,
...
ALTER TABLE public."T_RunMeasure" OWNER TO "user";

--
-- Name: T_RunMeasure_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

CREATE SEQUENCE public."T_RunMeasure_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."T_RunMeasure_seq" OWNER TO "user";

--
-- Name: T_RunMeasure_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user
--

ALTER SEQUENCE public."T_RunMeasure_seq" OWNED BY public."T_RunMeasure".id;
...
-- Name: M_User id; Type: DEFAULT; Schema: public; Owner: user
--
...
--
-- Name: M_User_Role_MLComponent id; Type: DEFAULT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_User_Role_MLComponent" ALTER COLUMN id SET DEFAULT nextval('public."M_User_Role_MLComponent_id_seq"'::regclass);


--
-- Name: M_Organization id; Type: DEFAULT; Schema: public; Owner: user
--
...
--
-- Name: M_Quality_Dimension_Level id; Type: DEFAULT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_Quality_Dimension_Level" ALTER COLUMN id SET DEFAULT nextval('public."M_Quality_Dimension_Level_id_seq"'::regclass);
...
--
-- Name: M_ReportTemplate id; Type: DEFAULT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_ReportTemplate" ALTER COLUMN id SET DEFAULT nextval('public."M_ReportTemplate_id_seq"'::regclass);
...
--
-- Name: M_Scope id; Type: DEFAULT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_Scope" ALTER COLUMN id SET DEFAULT nextval('public."M_Scope_id_seq"'::regclass);


--
-- Name: M_Scope_QualityDimension id; Type: DEFAULT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_Scope_QualityDimension" ALTER COLUMN id SET DEFAULT nextval('public."M_Scope_QualityDimension_id_seq"'::regclass);
...
--
-- Name: M_TestInventoryTemplate_Compatible_Package id; Type: DEFAULT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_TestInventoryTemplate_Compatible_Package" ALTER COLUMN id SET DEFAULT nextval('public."M_TestInventoryTemplate_Compatible_Package_id_seq"'::regclass);



--
-- Name: M_TestInventoryTemplate_Additional_Info id; Type: DEFAULT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_TestInventoryTemplate_Additional_Info" ALTER COLUMN id SET DEFAULT nextval('public."M_TestInventoryTemplate_Additional_Info_id_seq"'::regclass);
...
--
-- Name: M_Role id; Type: DEFAULT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_Role" ALTER COLUMN id SET DEFAULT nextval('public."M_Role_id_seq"'::regclass);

--
-- Name: M_Guideline id; Type: DEFAULT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_Guideline" ALTER COLUMN id SET DEFAULT nextval('public."M_Guideline_id_seq"'::regclass);


--
-- Name: M_Guideline_Schema_File id; Type: DEFAULT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_Guideline_Schema_File" ALTER COLUMN id SET DEFAULT nextval('public."M_Guideline_Schema_File_id_seq"'::regclass);
...
--
-- Name: T_RunMeasure id; Type: DEFAULT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."T_RunMeasure" ALTER COLUMN id SET DEFAULT nextval('public."T_RunMeasure_id_seq"'::regclass);
...
--
-- Name: M_Organization M_Organization_organizer_id_key; Type: CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_Organization"
    ADD CONSTRAINT "M_Organization_organizer_id_key" UNIQUE KEY (organizer_id);


--
-- Name: M_User M_User_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: M_User M_User_account_id_key; Type: CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_User"
    ADD CONSTRAINT "M_User_account_id_key" UNIQUE KEY (account_id);


--
-- Name: M_User_Role_MLComponent M_User_Role_MLComponent_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_User_Role_MLComponent"
    ADD CONSTRAINT "M_User_pkey" PRIMARY KEY (id);
...
--
-- Name: M_Quality_Dimension_Level M_Quality_Dimension_Level_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_Quality_Dimension_Level"
    ADD CONSTRAINT "M_Quality_Dimension_Level_pkey" PRIMARY KEY (id);
...
--
-- Name: M_ReportTemplate M_ReportTemplate_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_ReportTemplate"
    ADD CONSTRAINT "M_ReportTemplate_pkey" PRIMARY KEY (id);
...
--
-- Name: M_Scope M_Scope_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_Scope"
    ADD CONSTRAINT "M_Scope_pkey" PRIMARY KEY (id);


--
-- Name: M_Scope_QualityDimension M_Scope_QualityDimension_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_Scope_QualityDimension"
    ADD CONSTRAINT "M_Scope_QualityDimension_pkey" PRIMARY KEY (id);
...
--
-- Name: M_TestInventoryTemplate_Compatible_Package M_TestInventoryTemplate_Compatible_Package_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_TestInventoryTemplate_Compatible_Package"
    ADD CONSTRAINT "M_TestInventoryTemplate_Compatible_Package_pkey" PRIMARY KEY (id);


--
-- Name: M_TestInventoryTemplate_Additional_Info M_TestInventoryTemplate_Additional_Info_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_TestInventoryTemplate_Additional_Info"
    ADD CONSTRAINT "M_TestInventoryTemplate_Additional_Info_pkey" PRIMARY KEY (id);
...
--
-- Name: M_Role M_Role_name_key; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: M_Role M_Role_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: M_Guideline M_Guideline_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_Guideline"
    ADD CONSTRAINT "M_Guideline_pkey" PRIMARY KEY (id);


--
-- Name: M_Guideline_Schema_File M_Guideline_Schema_File_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_Guideline_Schema_File"
    ADD CONSTRAINT "M_Guideline_Schema_File_pkey" PRIMARY KEY (id);
...
--
-- Name: T_RunMeasure T_RunMeasure_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."T_RunMeasure"
    ADD CONSTRAINT "T_RunMeasure_pkey" PRIMARY KEY (id);
...
--
-- Name: M_MLComponent M_Guideline_Schema_File_guideline_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_Guideline_Schema_File"
    ADD CONSTRAINT "M_Guideline_Schema_File_guideline_id_fkey" FOREIGN KEY (guideline_id) REFERENCES public."M_Guideline"(id);
...
--
-- Name: M_MLComponent M_MLComponent_guideline_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_MLComponent"
    ADD CONSTRAINT "M_MLComponent_guideline_id_fkey" FOREIGN KEY (guideline_id) REFERENCES public."M_Guideline"(id);
...
ALTER TABLE ONLY public."M_MLComponent"
    ADD CONSTRAINT "M_MLComponent_scope_id_fkey" FOREIGN KEY (scope_id) REFERENCES public."M_Scope"(id);
...
--
-- Name: M_User M_User_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_User"
    ADD CONSTRAINT "M_User_org_id_fkey" FOREIGN KEY (org_id) REFERENCES public."M_Organization"(id);


--
-- Name: M_User_Role_MLComponent M_MLComponent_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_User_Role_MLComponent"
    ADD CONSTRAINT "M_User_Role_MLComponent_user_id_fkey" FOREIGN KEY (user_id) REFERENCES public."M_User"(id);


--
-- Name: M_User_Role_MLComponent M_MLComponent_role_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_User_Role_MLComponent"
    ADD CONSTRAINT "M_User_Role_MLComponent_role_id_fkey" FOREIGN KEY (role_id) REFERENCES public."M_Role"(id);


--
-- Name: M_User_Role_MLComponent M_User_Role_MLComponent_ml_component_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_User_Role_MLComponent"
    ADD CONSTRAINT "M_User_Role_MLComponent_ml_component_id_fkey" FOREIGN KEY (ml_component_id) REFERENCES public."M_MLComponent"(id);


--
-- Name: M_Quality_Dimension M_Quality_Dimension_guideline_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_Quality_Dimension"
    ADD CONSTRAINT "M_Quality_Dimension_guideline_id_fkey" FOREIGN KEY (guideline_id) REFERENCES public."M_Guideline"(id);


--
-- Name: M_Quality_Dimension_Level M_Quality_Dimension_Level_quality_dimension_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_Quality_Dimension_Level"
    ADD CONSTRAINT "M_Quality_Dimension_Level_quality_dimension_id_fkey" FOREIGN KEY (quality_dimension_id) REFERENCES public."M_Quality_Dimension"(id);
...
--
-- Name: M_ReportTemplate M_ReportTemplate_guideline_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_ReportTemplate"
    ADD CONSTRAINT "M_ReportTemplate_guideline_id_fkey" FOREIGN KEY (guideline_id) REFERENCES public."M_Guideline"(id);


--
-- Name: M_Scope M_Scope_guideline_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_Scope"
    ADD CONSTRAINT "M_Scope_guideline_id_fkey" FOREIGN KEY (guideline_id) REFERENCES public."M_Guideline"(id);


--
-- Name: M_Scope_QualityDimension M_Scope_QualityDimension_qd_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_Scope_QualityDimension"
    ADD CONSTRAINT "M_Scope_QualityDimension_guideline_id_fkey" FOREIGN KEY (guideline_id) REFERENCES public."M_Guideline"(id);
...
ALTER TABLE ONLY public."M_Scope_QualityDimension"
    ADD CONSTRAINT "M_Scope_QualityDimension_qd_id_fkey" FOREIGN KEY (quality_dimension_id) REFERENCES public."M_Quality_Dimension"(id);


--
-- Name: M_Scope_QualityDimension M_Scope_QualityDimension_scope_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_Scope_QualityDimension"
    ADD CONSTRAINT "M_Scope_QualityDimension_scope_id_fkey" FOREIGN KEY (scope_id) REFERENCES public."M_Scope"(id);
...
--
-- Name: M_TestInventoryTemplate_Compatible_Package M_TestInventoryTemplate_Compatible_Package_inventory_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_TestInventoryTemplate_Compatible_Package"
    ADD CONSTRAINT "M_TestInventoryTemplate_Compatible_Package_inventory_template_id_fkey" FOREIGN KEY (inventory_template_id) REFERENCES public."M_TestInventoryTemplate"(id_);


--
-- Name: M_TestInventoryTemplate_Additional_Info M_TestInventoryTemplate_Additional_Info_inventory_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."M_TestInventoryTemplate_Additional_Info"
    ADD CONSTRAINT "M_TestInventoryTemplate_Additional_Info_inventory_template_id_fkey" FOREIGN KEY (inventory_template_id) REFERENCES public."M_TestInventoryTemplate"(id_);
...
--
-- Name: T_RunMeasure T_RunMeasure_run_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public."T_RunMeasure"
    ADD CONSTRAINT "T_RunMeasure_run_id_fkey" FOREIGN KEY (run_id) REFERENCES public."T_Run"(id);
